...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_chk_1` CHECK ((`user_type` in (_utf8mb4'applicant',_utf8mb4'employer')))
...
-- Dump completed on 2026-04-12 20:39:50
